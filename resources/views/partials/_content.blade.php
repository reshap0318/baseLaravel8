	...
	<div class="container">
			...
			<div class="col-xl-8">
				<div class="row">
					...
					<div class="col-xl-9">
						...
						<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-10","page":"index"}]/-->
						...
						<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-10","page":"index"}]/-->
					</div>
				</div>
				<div class="row">
					<div class="col-xl-6">

						<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-13","page":"index"}]/-->
						...
						<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-13","page":"index"}]/-->
						<div class="row">
							<div class="col-xl-6">

								<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-11","page":"index"}]/-->
								...
								<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-11","page":"index"}]/-->
							</div>
							<div class="col-xl-6">

								<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-12","page":"index"}]/-->
								...
								<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-12","page":"index"}]/-->
							</div>
						</div>
					</div>
					<div class="col-xl-6">

						<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-14","page":"index"}]/-->
						...
						<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-14","page":"index"}]/-->
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-10","page":"index"}]/-->
						...
						<div class="card-toolbar">
							<div class="dropdown dropdown-inline">
								...
								<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
									...
									<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/dropdowns/dropdown-3","page":"index"}]/-->
									...
									<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/dropdowns/dropdown-3","page":"index"}]/-->
								</div>
							</div>
						</div>
					</div>
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-10","page":"index"}]/-->
			</div>
			<div class="col-lg-6">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-11","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-11","page":"index"}]/-->
			</div>
		</div>
